...
# if (USE_MYSQL)
  // NOTE: mysql connection happens here so the master can create the manifest table before launching the dvopsps_clients
  MYSQL  mysqlBase;
...
# endif
  ...
  create_manifest_mysql ("objects", mysqlReal);
